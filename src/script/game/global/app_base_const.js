...
APP_BASE_CONST.init = function () {
	...
	let _EventName = {
		...
		// 刷新显示的悬浮广告
		EN_REFRESH_ONSHOW_FLOW_AD: "EN_REFRESH_ONSHOW_FLOW_AD",
		// 取消跳转
		EN_CANCEL_NAVIGATION_FROM_AD: "EN_CANCEL_NAVIGATION_FROM_AD",
		// 获得跳转红包
		EN_GOT_NAVIGATION_REDPACKAGE: "EN_GOT_NAVIGATION_REDPACKAGE"
	}
	...
	// 预下载资源配置
	let _PreDownloadAssets = []

	// global
	window.G_PreDownloadAssets = _PreDownloadAssets
	...
	let _SwitchName = {
		...
		// 按钮类误触配置
		SN_BTN_MISTAKE_CFG: "btnMistakeCfg",
		// 游戏中banner状态配置
		SN_GAMING_BANNER_STATE_CFG: "gamingBannerCfg",
		// 防加载页状态配置
		SN_FAKE_LOADING_CFG: "fakeLoadingCfg",
		// 开启跳转确认框页面配置
		SN_GET_AUTO_RANDOM_NAV_PAGE_CFG: "autoRandomNavPagesCfg",
		// 导出页状态
		SN_IS_EXPORT_AUTO_OPEN: "isExportAutoOpen",
		// 签到页状态
		SN_IS_SIGN_AUTO_OPEN: "isSignAutoOpen",
		// 皮肤试用状态
		SN_IS_TRY_SKIN_AUTO_OPEN: "isTrySkinOpen",
		// 更多好玩状态
		SN_WHEN_MORE_GAME_AUTO_OPEN_CFG: "isMoreGameOpen",
		// 是否新游戏
