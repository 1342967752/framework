...
export default class ContinuousTweenMgr {
    ...
    setTarget(target) {
        if (this.targets.indexOf(target)<0) {//动画bug
    ...
    doNext() {
        ...
        for (let i = 0; i < this.targets.length; i++) {
            ...
            if(i==0){
                //this.isTest&&console.error("0",this.isPlayTween);
                this.cTween.push(Laya.Tween.to(this.targets[i], prop, time, ease,null, 0, true, false));
                Laya.timer.once(time,this,this._doNext);
            }else{
                this.cTween.push(Laya.Tween.to(this.targets[i], prop, time, ease, null, 0, true, false));
            }
        ...
        //this.isTest&&console.error("play",this.isPlayTween);
    ...
    _doNext() {
        ...
        //this.isTest&&console.error("1",this.isPlayTween);
    }
    ...
    setDelayTime(time) {
        ...
        //this.isTest&&console.error("结束---1")
        this.isPlayTween = false;
        this.clearTween();
