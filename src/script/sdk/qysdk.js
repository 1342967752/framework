...
import {_NativeAdvMgr} from "./helper/plat/native/adv/native_adv_mgr.js";
import {_NativeWXMgr} from "./helper/plat/native/wx/native_wx_mgr.js";
...
QYSDK.init = function () {
    ...
    G_GameDB.onLoad(function () {
        ...
        // Native Adv
        window.G_NativeAdvMgr = _NativeAdvMgr.getInstance()

        // Native WX
        window.G_NativeWXMgr = _NativeWXMgr.getInstance()
