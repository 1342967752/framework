...
var _SDKCfg = function() {
	...
	function init() {
		...
		return {
			...
			// 获取asset版本地址
			getAssetResVersion: function () {
				// body...
				if (_assetResVersion === -1) {
					_assetResVersion = G_GameDB.getBaseConfigByID(BaseConfigIDs["BC_ASSET_RES_VERSION"]).num
				}

				return _assetResVersion;
			},
