...
*/
export default class PlatBaseHelper {
	constructor() {
		// log
	...
	isNativePlatform() {
		// body...
		if (typeof window.conch !== "undefined") {
			return true
		}
		else {
			return false
	...
	isAndroidNativePlatform() {
		// body...
		if (typeof window.conch !== "undefined" && window.conchConfig.getOS() === "Conch-android") {
			return true
		}
		else {
			return false
	...
	isIOSNativePlatform() {
		// body...
		if (typeof window.conch !== "undefined" && window.conchConfig.getOS() === "Conch-ios") {
			return true
		}
		else {
			return false
